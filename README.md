# Tech-track-22-23
<p align="center">
  <img width="100%" src="https://github.com/ArisRosbach/tech-track-22-23/blob/main/images/EindProduct-TechTrack.png" />
</p>
...
## Installatie 💻
### Aan de slag
Wil je aan de slag met mijn project? Zorg er dan eerst voor dat je zeker weet dat je [Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git), [Node](https://nodejs.org/en/download/) en [NPM](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) hebt geïnstalleerd op jouw computer.
